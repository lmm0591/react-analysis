...
describe('defaultPropsHandler', () => {
  ...
  function test(definition) {
    ...
    expect(documentation.toObject().props).toEqual({
      foo: {
        defaultValue: {
          value: '"bar"',
          computed: false,
  ...
  describe('ObjectExpression', () => {
    it('should find prop default values that are literals', () => {
      ...
      `;
      console.log(parse(src).get('body', 0, 'expression'))
      test(parse(src).get('body', 0, 'expression'));
    });
  });

  xdescribe('ClassDeclaration with static defaultProps', () => {
    it('should find prop default values that are literals', () => {
      var src = `
        class Foo {
          static defaultProps = {
  ...
  xdescribe('ClassExpression with static defaultProps', () => {
    it('should find prop default values that are literals', () => {
      var src = `
        var Bar = class {
          static defaultProps = {
  ...
  xit('should only consider Property nodes, not e.g. spread properties', () => {
    var src = `
      ({
        getDefaultProps: function() {
          return {
  ...
  xdescribe('Functional components with default params', () => {
